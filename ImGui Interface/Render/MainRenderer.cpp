...
void ImGui_BrdigeRenderer::RenderAbout()
{
	...
	ImGui::NewLine();
	{
		SG::Version ver = SG::PluginManager->GetHostVersion();
	...
	ImGui::NewLine();
	{
		SG::Version ver = SG::ThisPlugin->GetPluginInfo()->m_Version;
		ImGui::Text("ImGui Interface: %i.%i.%i.%i", ver.major(), ver.minor(), ver.build(), ver.revision());
		ImGui::Separator();
		ImGui::Text("By 01Pollux/WhiteFalcon.");
		ImGui::Text("licensed under the GNU General Public License v3.0, see LICENSE for more information.");
	}
